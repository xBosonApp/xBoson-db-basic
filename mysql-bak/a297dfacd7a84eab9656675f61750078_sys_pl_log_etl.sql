...
--
-- Table structure for table `sys_pl_log_etl`
--

DROP TABLE IF EXISTS `sys_pl_log_etl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sys_pl_log_etl` (
  ...
  PRIMARY KEY (`logid`),
  KEY `sys_pl_log_etl_flowid` (`flowid`),
  KEY `sys_pl_log_etl_flowid_runningid` (`flowid`,`runningid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ETL日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_pl_log_etl`
--

LOCK TABLES `sys_pl_log_etl` WRITE;
/*!40000 ALTER TABLE `sys_pl_log_etl` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_pl_log_etl` ENABLE KEYS */;
UNLOCK TABLES;
