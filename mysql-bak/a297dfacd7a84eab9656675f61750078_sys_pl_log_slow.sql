...
--
-- Table structure for table `sys_pl_log_slow`
--

DROP TABLE IF EXISTS `sys_pl_log_slow`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sys_pl_log_slow` (
  ...
  PRIMARY KEY (`logid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='慢日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_pl_log_slow`
--

LOCK TABLES `sys_pl_log_slow` WRITE;
/*!40000 ALTER TABLE `sys_pl_log_slow` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_pl_log_slow` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-15 15:35:15
