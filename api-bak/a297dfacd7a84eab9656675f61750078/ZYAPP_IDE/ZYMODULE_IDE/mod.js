...
// http://localhost:8080/ds/ide/mod?app=mdm&org=zr&s=d&openid=dean&type=0&appid=z&modid=z&nm=znm&about=about&status=1
  ...
  // 验证必要参数
  if (type == null || appId == null || modId == null) {
    sys.setRetData("1");
    return;
  }
  ...
  var sqlModCnt = "select count(*) cnt from sys_apps, sys_modules where sys_apps.appid = sys_modules.appid and sys_apps.appflag = '0' and sys_modules.auflag = '0' and sys_modules.appid = ? and sys_modules.moduleid = ?";
