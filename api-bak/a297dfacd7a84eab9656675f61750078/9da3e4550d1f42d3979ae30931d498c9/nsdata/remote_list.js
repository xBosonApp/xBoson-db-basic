...
var bind = [];
var ssql = ['Select * From ns_ex_remote'];
var hasWhere = 0;
...
//
addCC('rtid',           'rtid = ?');
addCC('authoritytype',  'authoritytype = ?');
addCC('username',       'username like ?', true);
addCC('license',        'license like ?', true);
addCC('rname',          'rname like ?', true);
addCC('status',         'status = ?');
