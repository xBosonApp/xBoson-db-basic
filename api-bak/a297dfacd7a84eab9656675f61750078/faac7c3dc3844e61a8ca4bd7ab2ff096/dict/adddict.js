...
// 验证参数
if(typecd==null||version==null||dictcd==null||dictnm==null||status==null){
    sys.setRetData("1");
    return;
}
// shortkey
...
var count = sql.query(chksql,[typecd,version,dictcd],"chkpk_r");
if(count > 0){
    sys.setRetData("2","主键重复！");
    return;
}
// 执行sql
var sql = "insert into sys_pl_cd2 (typecd,version,dictcd,dictnm,shortkey,status,mark,createdt,updatedt) values (?,?,?,?,?,?,?,?,?)";
