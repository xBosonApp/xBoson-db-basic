...
var bind = [];
var ssql = ['Select * From ns_ex_cri'];
var hasWhere = 0;
...
//
addCC('criid',        'criid = ?');
addCC('standardcode', 'standardcode like ?', true);
addCC('standardname', 'standardname like ?', true);
addCC('setcode',      'setcode like ?', true);
addCC('setcodenode',  'setcodenode like ?', true);
addCC('table_name',   'table_name like ?', true);
addCC('typecd',       'typecd = ?');
addCC('status',       'status = ?');
