...
--
-- Table structure for table `sys_pl_log_unauth`
--

DROP TABLE IF EXISTS `sys_pl_log_unauth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sys_pl_log_unauth` (
  ...
  `remote_ip` varchar(15) DEFAULT NULL COMMENT '用户端IP',
  `appid` varchar(32) DEFAULT NULL COMMENT '应用ID',
  `moduleid` varchar(50) DEFAULT NULL COMMENT '模块ID',
  `apiid` varchar(50) DEFAULT NULL COMMENT 'API ID',
  `createdt` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`logid`),
  KEY `sys_pl_log_unauth_log_error_type` (`log_error_type`),
  KEY `sys_pl_log_unauth_log_level` (`log_level`),
  KEY `sys_pl_log_unauth_log_time` (`log_time`),
  KEY `sys_pl_log_unauth_pid` (`pid`),
  KEY `sys_pl_log_unauth_user_key` (`user_key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='未授权访问日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_pl_log_unauth`
--

LOCK TABLES `sys_pl_log_unauth` WRITE;
/*!40000 ALTER TABLE `sys_pl_log_unauth` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_pl_log_unauth` ENABLE KEYS */;
UNLOCK TABLES;
