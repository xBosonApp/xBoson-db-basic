...
if(dn==null||dbtype==null||user_name==null|| dhost==null || dport==null){
  sys.setRetData("1");
  return;
}
...
var did=sys.uuid();
var sqlIns="INSERT INTO sys_pl_drm_ds001 (dn,did,owner,dbtype,en,cn,url,user_name,pass,mark,status,flg,dhost,dport,pool_enabled,prop,createdt,updatedt) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
var dt = sys.currentTimeString();
var paramIns=[dn,did,owner,dbtype,en,cn,url,user_name,pass,mark,status,flg,dhost,dport,pool_enabled,prop,dt,dt];
sql.update(sqlIns,paramIns);
