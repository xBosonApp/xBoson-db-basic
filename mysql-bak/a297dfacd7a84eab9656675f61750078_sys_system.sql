...
CREATE TABLE `sys_system` (
  ...
  `sysnm` varchar(50) NOT NULL COMMENT '系统名称',
  `ip` varchar(15) DEFAULT NULL COMMENT 'IP',
  `port` varchar(5) DEFAULT NULL COMMENT '端口',
  `uri` varchar(100) DEFAULT NULL COMMENT 'URI、域名',
  `inner_flag` char(1) DEFAULT NULL COMMENT '内部/外部系统标记',
  ...
  `pid` char(32) DEFAULT NULL COMMENT '使用者PID',
  PRIMARY KEY (`sysid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统注册信息表';
...
INSERT INTO `sys_system` VALUES ('e9e225d1fd614ceb80792a59a47516a9','基层医疗','192.168.10.80','80',NULL,'1','afb9a9a1c80647e6a0d7e807f68e055a',NULL,'1','2016-11-29 17:44:23','2016-11-29 17:44:23','d7bc1ee05b0b4e77ba00f1ee16eabc5d');
...
-- Dump completed on 2023-02-15 15:35:30
