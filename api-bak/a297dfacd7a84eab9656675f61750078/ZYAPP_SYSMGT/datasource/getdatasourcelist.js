...
if(se.isPlatformOrg()) {
  sqlSel ="SELECT a.did,a.en,a.cn,a.owner,a.user_name,'********' pass,a.url,a.dbtype,a.mark,o.de0810013j as orgnm,a.pool_enabled,a.status,a.dn,a.flg,a.createdt,a.updatedt"+
  ...
  sqlSel ="SELECT a.did,a.dn,a.flg,a.en,a.cn,a.owner,a.user_name,'********' pass,a.url,a.dbtype,a.mark,o.de0810013j as orgnm,a.pool_enabled,a.status,a.createdt,a.updatedt"+
    " from sys_pl_drm_ds001 a "+
    "left join mdm_org o on a.owner = o.orgid and  o.status = '1' ";
