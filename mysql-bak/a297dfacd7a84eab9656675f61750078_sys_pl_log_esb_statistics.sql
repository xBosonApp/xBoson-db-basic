...
--
-- Table structure for table `sys_pl_log_esb_statistics`
--

DROP TABLE IF EXISTS `sys_pl_log_esb_statistics`;
...
CREATE TABLE `sys_pl_log_esb_statistics` (
  ...
  `serviceid` char(32) DEFAULT NULL COMMENT '服务ID',
  `runningid` char(32) DEFAULT NULL COMMENT '服务单次运行ID',
  ...
  PRIMARY KEY (`logid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ESB集群统计日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_pl_log_esb_statistics`
--

LOCK TABLES `sys_pl_log_esb_statistics` WRITE;
/*!40000 ALTER TABLE `sys_pl_log_esb_statistics` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_pl_log_esb_statistics` ENABLE KEYS */;
UNLOCK TABLES;
