...
var typecd = sys.getUUID();
var dt = sys.currentTimeString();

var sql = " insert into sys_bi_tree_info(typecd,typenm,parentcd,treetype,shortkey,status,mark,createdt,updatedt) values(?,?,?,?,?,?,?,?,?) ";

var params = [typecd,typenm,parentcd,'1',shortkey,status,mark,dt,dt];
