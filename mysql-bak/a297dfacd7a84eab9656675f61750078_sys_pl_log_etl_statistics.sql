...
--
-- Table structure for table `sys_pl_log_etl_statistics`
--

DROP TABLE IF EXISTS `sys_pl_log_etl_statistics`;
...
CREATE TABLE `sys_pl_log_etl_statistics` (
  ...
  PRIMARY KEY (`logid`),
  KEY `sys_pl_log_etl_statistics_log_date_char` (`log_date_char`),
  KEY `dt_instanceid` (`log_date_char`,`instanceid`),
  KEY `dt_instanceid_daqid` (`log_date_char`,`instanceid`,`daqid`),
  KEY `dt_instanceid_daqid_jobid` (`log_date_char`,`instanceid`,`daqid`,`jobid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ETL集群统计日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sys_pl_log_etl_statistics`
--

LOCK TABLES `sys_pl_log_etl_statistics` WRITE;
/*!40000 ALTER TABLE `sys_pl_log_etl_statistics` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_pl_log_etl_statistics` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-15 15:35:13
