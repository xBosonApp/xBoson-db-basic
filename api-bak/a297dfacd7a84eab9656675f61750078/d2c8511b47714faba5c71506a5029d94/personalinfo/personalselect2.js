...
// var sqlSelect = "select p.pid,u.userid, p.de0201039, p.de0201040, p.de0201010, p.de0201012 from mdm_personal_info p, sys_userinfo u where p.pid = u.pid and p.status = '1' and u.status = '1' ";
// var params = [];
// //查询条件
// if(userid != null){
